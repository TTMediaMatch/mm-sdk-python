...
def main():
    ...
    try:
        matchs = sdk_client.live_asset_service.get_live_match(asset_id,start_time,end_time,page,pageSize)
        print(matchs)
    ...
    try:
        matchs = sdk_client.live_asset_service.get_live_match(asset_id,start_time,end_time)
        print(matchs)
    except Exception as e:
        print(f"An error occurred querying delivery status: {e}")
